                            ...
                            <div class="block__content">
                                <div class="articles articles__vertical">
                                    ...
                                    $comments = mysqli_query($connection,
                                        "SELECT * FROM `comments` WHERE `articles_id` = " . (int)$art['id'] . " ORDER BY `id` DESC");
                                    ...
                                    while ($comment = mysqli_fetch_assoc($comments)) {
                                        ...
                                        <article class="article">
                                            <div class="article__image"
                                                 style="background-image: url(https://ru.gravatar.com/avatar/<?php echo md5(strtolower(trim($comment['email']))); ?>?s=125);">
                                            </div>
                                ...
                                <form class="form" method="POST"
                                    ...
                                    <div class="form__group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form__control" required="" name="email"
                                                       placeholder="Введите e-mail (будет скрыт)"
